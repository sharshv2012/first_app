...
class GradientContainer extends StatelessWidget {
  const GradientContainer(this.colour1, this.colour2,
      {super.key}); // a constructor , super.key passes key to the super class i.e Stateless widget.
  ...
  const GradientContainer.skyBlue({super.key})
      : colour1 = Colors.teal,
        colour2 = Colors.tealAccent; // this is another constructor.
  final Color colour1;
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            colour1,
            colour2
          ], // in case of using list of colors just write "colours" no [].
